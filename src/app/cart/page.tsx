  ...
  if (items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        ...
        <Link
          href="/"
          className="mt-8 inline-block bg-blue-600 text-white px-8 py-3 rounded-xl font-medium hover:bg-blue-700 transition"
        >
          Continue Shopping
        </Link>
      </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start">
        <div className="lg:col-span-8">
          <ul
            role="list"
            className="border-t border-gray-200 dark:border-zinc-800 divide-y divide-gray-200 dark:divide-zinc-800"
          >
            {items.map((item) => {
                    ...
                    <div className="sm:grid sm:grid-cols-2 sm:gap-x-6">
                      <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white">
                          {item.product.price.toLocaleString()} Ks
                        </p>
                      ...
                      <div className="mt-4 sm:mt-0 flex items-center justify-between sm:justify-end gap-3">
                        <div className="flex items-center border border-gray-300 dark:border-zinc-700 rounded-md">
                          ...
                          <button
                            ...
                            className="px-2 py-1 text-gray-600 hover:text-gray-900 disabled:cursor-not-allowed disabled:text-gray-300 dark:text-gray-400 dark:hover:text-white dark:disabled:text-zinc-700"
                          >
          ...
          <dl className="mt-6 space-y-4">
            ...
            <div className="flex items-center justify-between border-t border-gray-200 dark:border-zinc-800 pt-4">
              ...
              <dd className="text-base font-medium text-gray-900 dark:text-white">
                {totals.totalPrice.toLocaleString()} Ks
              </dd>
            </div>
          </dl>
