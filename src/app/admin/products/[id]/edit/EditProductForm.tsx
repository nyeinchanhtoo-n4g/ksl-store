      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            min="0"
            className="mt-1 block w-full rounded-md border-gray-300 dark:border-zinc-700 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2 px-3 border bg-white dark:bg-zinc-800 text-gray-900 dark:text-white"
          />
        </div>
        <div>
